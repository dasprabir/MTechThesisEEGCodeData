%%
%     
%     Instantaneous frequency in simulated and in real data
% 
%
%%
...
time = (0:length(singlechandata)-1)/srate;

figure(2), clf
pwelch(singlechandata,srate,srate/2,srate*2,srate)
set(gca,'xlim',[0 40])
...
feegdata = filtfilt(filtkern,1,double(singlechandata));

% plot the data for comparison
figure(4), clf
plot(time,singlechandata, time,feegdata ,'linew',2)
xlabel('Time (s)'), ylabel('Amplitude')
zoom on
